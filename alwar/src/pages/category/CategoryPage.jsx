                                                                ...
                                                                <div
                                                                    ...
                                                                    {cartItems.some((p) => p.id === item.id)
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className=" bg-teal-700 hover:bg-green-600 w-full text-white py-[4px] rounded-lg font-bold">
                                                                            Delete From Cart
                                                                        </button>
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className=" bg-teal-500 hover:bg-green-600 w-full text-white py-[4px] rounded-lg font-bold">
                                                                            Add To Cart
                                                                        </button>
                                                                    }
                                                                </div>
